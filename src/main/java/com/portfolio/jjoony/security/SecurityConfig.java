...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception{
		...
		//역할에 따라 요청 허용/제한 설정
		.authorizeRequests()
		.requestMatchers("insert_user","/login_user","/find_about/**","list_project/**","/list_skills/**").permitAll()
		.requestMatchers("/insert_skills","/update_project","/insert_project").hasAnyRole("TEST","ADMIN")//프로젝트 등록 가능,프로젝트 수정, 삭제 및 내 정보 수정 불가
